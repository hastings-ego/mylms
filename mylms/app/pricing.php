        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-slate-50 rounded-2xl p-8 text-center border border-slate-200">
                    <h2 class="text-2xl font-bold text-slate-900">Monthly</h2>
                ...
                <div class="bg-white rounded-2xl p-8 text-center border-2 border-brand-500 shadow-lg relative">
                    ...
                    <h2 class="text-2xl font-bold text-slate-900">Yearly</h2>
                    <div class="mt-4 text-5xl font-extrabold text-brand-600">R5 499,99</div>
                    <p class="text-slate-500 mt-2">per year</p>
                    <ul class="mt-6 space-y-3 text-slate-600 text-left">
